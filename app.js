...
function App() {
    ...
    document.querySelector('.about-react').addEventListener('click', function () {
        playClickSound();
        increasezcounter();
        document.querySelector('.'+ aboutbox).style.zIndex = zcounter;
    });
    document.querySelector('.links-react').addEventListener('click', function () {
        playClickSound();
        increasezcounter();
        document.querySelector('.'+ linkboxclass).style.zIndex = zcounter;
    });
    document.querySelector('.works-react').addEventListener('click', function () {
        playClickSound();
        increasezcounter();
        document.querySelector('.'+ workboxclass).style.zIndex = zcounter;
    });
    document.querySelector('.faq-react').addEventListener('click', function () {
        playClickSound();
        increasezcounter();
        document.querySelector('.' + faqboxclass).style.zIndex = zcounter;
    });
    document.querySelector('.contacts-react').addEventListener('click', function () {
        playClickSound();
        increasezcounter();
        document.querySelector('.' + contactboxclass).style.zIndex = zcounter;
    });

    document.querySelector('.header-1').addEventListener('click', playClickSoundtheme)
    ...
    return <>
        ...
        {showBoxabout && (
        <Draggable>
            <div className={aboutbox} onClick={() => {increasezcounter(); document.querySelector('.' + aboutbox).style.zIndex = zcounter}}>
        ...
        {showBoxlinks && (
        <Draggable>
            <div className={linkboxclass} onClick={() => {increasezcounter(); document.querySelector('.' + linkboxclass).style.zIndex = zcounter}}>
        ...
        {showBoxworks && (
        <Draggable>
            <div className={workboxclass} onClick={() => {increasezcounter(); document.querySelector('.' + workboxclass).style.zIndex = zcounter}}>
                <div className={topboxclass}>
                    <div style={{marginLeft: 20}}>
                        works
                    </div>
                    ...
                    <div style={{overflowY: 'scroll',paddingLeft: '48px',paddingRight: '48px', paddingTop: '20px', height: '95%', display: 'flex', flexDirection: 'column', gap: '40px'}}>
                        ...
                        <div>
                            ...
                            <div style={{display: 'grid', justifyContent: "space-evenly", width: "100%", gridTemplateColumns: 'repeat(2, 1fr)', gap: '10px'}}>
                                <video src="erwin(final edit).mp4" className="work-video" controls></video>
                                <video src="one piece_1.mp4" className="work-video" controls></video>
                                <video src="Attack On Titans_1.mp4" className="work-video" controls></video>
                                <video src="kamra no. 509 - Made with Clipchamp.mp4" className="work-video" controls></video>
                            </div>
                        </div>
                        <div><hr style={{ height: '1px',  backgroundColor: 'gray', border: 'none' }} /></div>
                        <div>
                            ...
                            <div style={{display: 'grid', width: "102%", height: '98%%', gridTemplateColumns: 'repeat(3, 1fr)', placeItems: 'center', gap: '5px'}}>
                                <img src="work-image-1.jpg" className="work-image work-image-zoom fullscreen-img" alt="Click to enlarge"></img>
                                <img src="work-image-2.jpg" className="work-image work-image-zoom fullscreen-img" alt="Click to enlarge"></img>
                                <img src="work-image-3.jpg" className="work-image work-image-zoom fullscreen-img" alt="Click to enlarge"></img>
                                <img src="work-image-4.jpg" className="work-image work-image-zoom fullscreen-img" alt="Click to enlarge"></img>
                                <img src="work-image-5.jpg" className="work-image work-image-zoom fullscreen-img" alt="Click to enlarge"></img>
                                <img src="work-image-6.jpg" className="work-image work-image-zoom fullscreen-img" alt="Click to enlarge"></img>
                                <img src="work-image-7.jpg" className="work-image work-image-zoom fullscreen-img" alt="Click to enlarge"></img>
                                <img src="work-image-8.jpg" className="work-image work-image-zoom fullscreen-img" alt="Click to enlarge"></img>
                                <img src="work-image-9.jpg" className="work-image work-image-zoom fullscreen-img" alt="Click to enlarge"></img>
                            </div>
        ...
        {showBoxfaq && (
        <Draggable>
            <div className={faqboxclass} onClick={() => {increasezcounter(); document.querySelector('.' + faqboxclass).style.zIndex = zcounter}}>
                <div className={topboxclass}>
                    <div style={{marginLeft: 20}}>
        ...
        {showBoxcontacts && (
        <Draggable>
            <div className={contactboxclass} onClick={() => {increasezcounter(); document.querySelector('.' + contactboxclass).style.zIndex = zcounter}}>
                <div className={topboxclass}>
                    <div style={{marginLeft: 20}}>
                        contacts
                    </div>
